...
class TovarController extends Controller
{
	...
	public function actionCreate()
	{
        ...
        $properties= Properties::model()->findAll();
		...
		if(isset($_POST['Tovar']))
		{
            ...
            if($model->save()) {
                ...
                if(isset($_POST['PropertiesTovar'])){
                    foreach($_POST['PropertiesTovar'] AS $attributesArray){
                        $model2=new PropertiesTovar;
                        $model2->attributes=$attributesArray;
                        $model2->id_tovar = $model->id;
                        $model2->save();
